...
package: 'custom'
description:
  Section is a flexible component used to group and display content in a clear and
  concise format.
---

## Import

111 zzzzzzzChakra UI exports 4 components to help you create a Section.
